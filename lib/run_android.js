...
module.exports = function(logger, config, cli, projectDir, finished) {
    ...
    var passthroughCommands = cli.__passthroughCommands,
    ...
    tiapp.find(projectDir, function(err, obj) {
        ...
        exec('ti', passthroughCommands, null, function(output) {
            ...
            var calabashParams = ['run', path.join(apkPath, apkName), '-p', 'android'].concat(cucumberParams);

		    exec('calabash-android', calabashParams, null, function(output) {
